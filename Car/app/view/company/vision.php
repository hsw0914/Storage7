    ...
    <div class="main_con">
        ...
        <div class="sub_con">
            <div class="sub_con_header">
                <ruby>COMPANY</ruby><h1>연혁 및 비전</h1>
                <ul>
                    <li><a href="/">HOME</a></li>
                    <li><a href="/app/view/company/index.php">회사소개</a></li>
                    <li><a href="/app/view/company/vision.php" class="color-red">연혁 및 비전</a></li>
                </ul>
            </div>
            <div class="sub_con_images vision">
                <img src="/static/img/company/intro02.jpg" alt="intro">
            </div>
        </div>
    </div>
</div>
