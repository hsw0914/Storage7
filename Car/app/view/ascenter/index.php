    ...
    <div class="main_con">
        ...
        <div class="sub_con">
            <div class="sub_con_header">
                <ruby>A/S CENTER</ruby><h1>A/S 센터</h1>
                <ul>
                    <li><a href="/">HOME</a></li>
                    <li><a href="/app/view/ascenter/index.php">A/S 센터</a></li>
                    <li><a href="/app/view/ascenter/index.php" class="color-red">A/S 정보</a></li>
                </ul>
            </div>
            <div class="sub_con_images as_index">
                <img src="/static/img/ascenter/center02.jpg" alt="center">
            </div>
        </div>
    </div>
</div>
